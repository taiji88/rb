...
<div id="catebody">
	...
	<div id="catinfo">
		...
		<div class="tab">
			...
			<li<?php if($type=='images'):?> class="on"<?php endif?>><a href="<?php echo $g['adm_href']?>&amp;layout=<?php echo $layout?>&amp;type=images">파일저장소</a></li>
		...
		<div class="editbox">
			...
			<?php $ftype = getFileType($fext)?>
				...
				<div class="imgbox" title="<?php echo $f?>">
					...
					<?php if($ftype==2):$isize=getimagessize($idir.$f)?>
					...
					<?php else:?>
					<table><tr><td><a href="<?php echo $g['s']?>/?r=<?php echo $r?>&amp;m=<?php echo $m?>&module=filemanager&front=main&editmode=Y&pwd=<?php echo urlencode($idir)?>&file=<?php echo $f?>" target="_blank"><img src="<?php echo $g['img_core']?>/file/big/<?php echo (is_file($g['path_core'].'images/file/big/'.$fext.'.gif')?$fext:'unknown')?>.gif" alt="<?php echo $f?>" /></a></td></tr></table>
					<?php endif?>
				</div>
