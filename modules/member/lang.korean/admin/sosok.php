...
<div id="sosokbox">
	...
	<div class="title">
		...
		<div class="xr">
			...
			<?php endif?>
			<input type="images" src="<?php echo $g['img_core']?>/_public/btn_save.gif" alt="save" title="그룹순서 저장" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="box">
	...
	<div class="title">
		...
		<div class="xr">
			...
			<input type="images" src="<?php echo $g['img_core']?>/_public/btn_save.gif" alt="save" title="저장" />
		</div>
		<div class="clear"></div>
	</div>
