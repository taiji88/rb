...
<div id="uplist">
	...
	<li id="uLi<?php echo $U['uid']?>">
		...
		<span class="name">
		<img src="<?php echo $g['img_core']?>/file/small/<?php echo is_file($g['path_core'].'images/file/small/'.$file_ext.'.gif')?$file_ext:'unknown'?>.gif" class="ext" alt="" />
...
function upfile_thumb(ext,img)
{
	if (ext == 'gif' || ext == 'jpg' || ext == 'png')
	{
		...
		getId('thumbbox').style.background = "url("+rooturl+"/_core/images/file/big/"+ext+".gif) center center no-repeat";
	}
}
