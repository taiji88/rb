	...
	<table>
		<tr>
			...
			<td class="td2">
				...
				<option value="<?php echo $tpl?>"<?php if($d['admin']['themepc']==$tpl):?> selected="selected"<?php endif?>>ㆍ<?php echo getFolderName($g['dir_module'].'lang.'.$_HS['lang'].'/theme/'.$tpl)?>(<?php echo str_replace('.php','',$tpl)?>)</option>
				<?php endwhile?>
				<?php closedir($dirs)?>
				</select>
		...
		<tr>
			...
			<td class="td2">
				...
				<?php while(false !== ($tpl = readdir($dirs))):?>
				<?php if($tpl=='.' || $tpl == '..')continue?>
				<option value="<?php echo $tpl?>"<?php if($d['admin']['thememobile']==$tpl):?> selected="selected"<?php endif?>>ㆍ<?php echo getFolderName($g['dir_module'].'lang.'.$_HS['lang'].'/theme/'.$tpl)?>(<?php echo str_replace('.php','',$tpl)?>)</option>
				<?php endwhile?>
				<?php closedir($dirs)?>
				</select>
