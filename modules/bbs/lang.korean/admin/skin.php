	...
	<div id="category">
		...
		<div class="tree">
			...
			<li>
				...
				<a href="<?php echo $g['adm_href']?>&amp;theme=<?php echo $skin?>"><span class="name<?php if($theme==$skin):?> on<?php endif?>"><?php echo getFolderName($tdir.$skin)?></span></a><span class="id">(<?php echo $skin?>)</span>
			</li>
			<?php endwhile?>
			<?php closedir($dirs)?>
			</ul>
