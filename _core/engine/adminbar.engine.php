...
<li><a href="#" onclick="__getLayerBox('<?php echo $g['s']?>/?r=<?php echo $r?>&amp;system=edit.all&amp;type=site','',800,500,'',false,'r');"><?php echo $lang['top']['site']?></a> <a href="<?php echo $g['s']?>/?r=<?php echo $r?>&amp;m=admin&amp;module=site&amp;type=makesite"><img src="<?php echo $g['img_core']?>/_public/btn_add_01.gif" alt="" title="<?php echo $lang['top']['newsite']?>" /></a></li>
...
<li>ㆍ<a href="<?php echo $g['s']?>/?r=<?php echo $r?>&amp;_themeConfig=<?php echo $_val[0]?>&amp;prelayout=<?php echo $d['layout']['dir']?>/<?php echo $d['layout']['blanklayout']?>"><?php echo $_val[1]?></a></li>
<?php endforeach?>
</ol>
</div>
</div>
...
function toolCheck0()
{
	...
	if(getId('_adminBox_').style.display == 'block')
	{
		...
		getId('_arr_icon_').src = rooturl+'/_core/images/_public/ico_under_01.gif';
	...
	else
	{
		...
		getId('_arr_icon_').src = rooturl+'/_core/images/_public/ico_under.gif';
