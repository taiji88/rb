  ...
  var Editor = function () {
    ...
    this.fontSize = function ($editable, sValue) {
      ...
      if (agent.bFF) {
		...
		// modify by Uygar Gumus (https://github.com/HackerWins/summernote/issues/80)
		$editable.find('font').each(function () {
			if (this.size == "3") {
				this.removeAttribute("size");
				this.style.fontSize = sValue + 'px';
			}
		});
      }
    };
    ...
    summernote: function (options) {
      options = $.extend({
        toolbar: [
          ...
          ['height', ['height']],
          ['table', ['table']],
          //['insert', ['link', 'picture', 'video']],		delete by taiji88 (14/2/11)
          ['view', ['fullscreen', 'codeview']],
          //['help', ['help']]			delete by taiji88 (14/2/11)
        ],
        lang: 'en-US'
      }, options);
